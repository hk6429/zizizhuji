...
export const PETS = [
  ...
  { id: 'kui',      name: '夔',     category: '字音', unlockAt: 5, desc: '一足雷獸，聲若洪鐘，鎮壓錯音。',
  ...
  { id: 'yinglong',  name: '應龍',  category: '成語', unlockAt: 5, desc: '助禹治水的神龍，滿腹成語掌故。',
  ...
  { id: 'dangkang', name: '當康',   category: '混合', unlockAt: 8, desc: '豐年之兆，字珠盈滿則現身相助。',
